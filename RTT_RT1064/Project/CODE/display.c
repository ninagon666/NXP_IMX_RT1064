...
void display_entry(void *parameter)
{
    ...
    lcd_showstr(0, 3, (int8 *)"w1_tec:");
    lcd_showstr(0, 4, (int8 *)"w2_tec:");
    lcd_showstr(0, 5, (int8 *)"w3_tec:");
    lcd_showstr(0, 6, (int8 *)"w4_tec:");
    lcd_showstr(0, 7, (int8 *)"Tag_ag1:");
    lcd_showstr(0, 8, (int8 *)"w1_tg:");
    ...
    {        
        ...
        lcd_showfloat(8 * 7, 3, motor_1.total_encoder, 6, 1);
        lcd_showfloat(8 * 7, 4, motor_2.total_encoder, 6, 1);
        lcd_showfloat(8 * 7, 5, motor_3.total_encoder, 6, 1);
        lcd_showfloat(8 * 7, 6, motor_4.total_encoder, 6, 1);
        lcd_showfloat(8 * 8, 7, Angle.target_angle, 3, 1);
        lcd_showfloat(8 * 6, 8, motor_1.target_speed, 3, 1);
