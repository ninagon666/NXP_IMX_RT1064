...
//====================================================软件 IIC 驱动====================================================
#define IMU963RA_SOFT_IIC_DELAY                     (60)              // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
...
#define IMU963RA_SPI                                (SPI_4        )     // 硬件 SPI 号
#define IMU963RA_SPC_PIN                            (SPI4_SCK_C23 )     // 硬件 SPI SCK 引脚
#define IMU963RA_SDI_PIN                            (SPI4_MOSI_C22)     // 硬件 SPI MOSI 引脚
#define IMU963RA_SDO_PIN                            (SPI4_MISO_C21)     // 硬件 SPI MISO 引脚
#define IMU963RA_CS_PIN                             (SPI4_CS0_C20)      // 硬件 CS 片选引脚
//====================================================硬件 SPI 驱动====================================================
#endif
